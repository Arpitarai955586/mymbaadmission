          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredCourses.map((course) => (
              ...
              >
                ...
                <div className="bg-gradient-to-br from-[#1E40AF] to-[#1E3A8A] p-6 text-white">
                  <div className="flex items-start justify-between mb-4">
                    <span className="px-4 py-2 bg-[#F97316] text-white text-xs font-bold rounded-full">
                      {course.degree}
                    </span>
                  ...
                  <h3 className="text-2xl font-bold mb-2 group-hover:text-[#F97316] transition-colors line-clamp-2">
                    {course.name}
                  </h3>
