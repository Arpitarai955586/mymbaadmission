      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12 space-y-6">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-[#1A1A1B] leading-tight">
            Explore <span className="text-[#1E40AF]">Top Colleges</span> in
            India
          </h1>

          <p className="text-[#2C3E50] text-xl max-w-3xl mx-auto leading-relaxed">
            Discover the best management institutions offering world-class
            education and exceptional career opportunities.
          </p>
        </div>
