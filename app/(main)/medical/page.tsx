...
export default function MedicalPage() {
  ...
  const medicalExams = [
    ...
    },
    {
      ...
      conductingBody: 'JIPMER Puducherry',
      examDate: '2026-06-05',
      lastDate: '2026-04-20',
      mode: 'Online',
      duration: '2.5 Hours',
      image: 'https://images.pexels.com/photos/3985153/pexels-photo-3985153.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
      featured: false,
    },
    {
      id: '5',
      title: 'AFMC 2026',
      fullName: 'Armed Forces Medical College Entrance Exam',
      conductingBody: 'Armed Forces Medical College',
      examDate: '2026-05-01',
      lastDate: '2026-03-31',
      mode: 'Online',
      duration: '2 Hours',
    ...
    {
      id: '6',
      title: 'CMC Vellore 2026',
      fullName: 'Christian Medical College Vellore Entrance Exam',
      conductingBody: 'CMC Vellore',
      examDate: '2026-05-15',
      lastDate: '2026-04-05',
      mode: 'Online',
      duration: '3 Hours',
  ...
  return (
    <div className="min-h-screen bg-[#F8F9F9]">
      ...
      <div className="bg-[#1A1A1B] text-white py-2 px-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4 text-sm">
            ...
            <span>NEET UG 2026 Application Form Released</span>
            <span className="text-gray-400">•</span>
            <span>AIIMS MBBS 2026 Notification Out</span>
          </div>
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-[#27AE60] to-[#1E8449] text-white overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg lg:text-xl mb-8 text-gray-200 leading-relaxed">
                Discover comprehensive information about prestigious medical entrance examinations in India.
                Access detailed guidance for MBBS, BDS, and postgraduate medical programs.
              </p>
              <div className="flex flex-wrap gap-4">
                ...
                <button className="border-2 border-white hover:bg-white hover:text-[#27AE60] text-white font-bold px-6 py-3 rounded-lg transition-colors">
                  Download Brochure
                </button>
              </div>
            </div>
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white rounded-xl shadow-xl p-4 hidden lg:block">
                <div className="flex items-center gap-3">
                  <div className="bg-[#27AE60] rounded-full p-2">
                    <Users className="text-white" size={20} />
                  </div>
                  <div>
                    <p className="font-bold text-gray-800">18,000+</p>
                    <p className="text-sm text-gray-600">Medical Seats</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl lg:text-4xl font-bold text-[#2C3E50] mb-4">
            Featured Medical Exams
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Explore the most prestigious medical entrance examinations for admission to top medical colleges
          </p>
        </div>
          ...
          {medicalExams.map((exam) => (
            <div key={exam.id} className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group">
              <div className="relative h-48 overflow-hidden">
                ...
                />
                {exam.featured && (
                  <div className="absolute top-4 left-4 bg-[#27AE60] text-white px-3 py-1 rounded-full text-xs font-bold">
                    FEATURED
                  </div>
                )}
              </div>
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between pt-4 border-t">
                  ...
                  <Link
                    ...
                    className="text-[#27AE60] hover:text-[#1E8449] font-semibold text-sm flex items-center gap-1 transition-colors"
                  >
                    View Details
      ...
      <section className="bg-[#27AE60] text-white py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold mb-6">
            Need Help with Medical Admissions?
          </h2>
          <p className="text-xl mb-8 text-gray-200 max-w-2xl mx-auto">
            Get expert guidance from medical counselors to choose the right medical college and exam preparation strategy.
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            <button onClick={openModal} className="bg-white text-[#27AE60] hover:bg-gray-100 font-bold px-8 py-4 rounded-lg transition-colors flex items-center gap-2">
              <Phone size={20} />
              Talk to Counselor
            </button>
            <button className="border-2 border-white hover:bg-white hover:text-[#27AE60] font-bold px-8 py-4 rounded-lg transition-colors">
              Download Free Guide
            </button>
          </div>
        </div>
