...
export default function EngineeringPage() {
  ...
  useEffect(() => {
    setFilter({ category: 'engineering' });
  }, [setFilter]);
  ...
  const engineeringExams = [
    {
      ...
      mode: 'Online',
      duration: '3 Hours',
      image: 'https://images.pexels.com/photos/1106357/pexels-photo-1106357.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
      featured: true,
    },
    {
      id: '2',
  ...
  return (
    <div className="min-h-screen bg-[#F8F9F9]">
      ...
      <div className="bg-[#1A1A1B] text-white py-2 px-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4 text-sm">
            ...
            <span>JEE Main 2026 City Intimation Slip Released</span>
            <span className="text-gray-400">•</span>
            <span>GATE 2026 Admit Card Out</span>
          </div>
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-[#5D4E37] to-[#3E2F1F] text-white overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg lg:text-xl mb-8 text-gray-200 leading-relaxed">
                Get comprehensive information about the most prestigious engineering entrance exams in India. 
                Stay updated with important dates, eligibility criteria, and preparation strategies.
              </p>
              <div className="flex flex-wrap gap-4">
                ...
                <button className="border-2 border-white hover:bg-white hover:text-[#5D4E37] text-white font-bold px-6 py-3 rounded-lg transition-colors">
                  Download Brochure
                </button>
              </div>
            </div>
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white rounded-xl shadow-xl p-4 hidden lg:block">
                <div className="flex items-center gap-3">
                  <div className="bg-[#922B21] rounded-full p-2">
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl lg:text-4xl font-bold text-[#2C3E50] mb-4">
            Featured Engineering Exams
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Explore the most sought-after engineering entrance examinations that open doors to premier institutions
          </p>
        </div>
          ...
          {engineeringExams.map((exam) => (
            <div key={exam.id} className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group">
              <div className="relative h-48 overflow-hidden">
                ...
                />
                {exam.featured && (
                  <div className="absolute top-4 left-4 bg-[#922B21] text-white px-3 py-1 rounded-full text-xs font-bold">
                    FEATURED
                  </div>
                )}
              </div>
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between pt-4 border-t">
                  ...
                  <Link 
                    ...
                    className="text-[#922B21] hover:text-[#7A2318] font-semibold text-sm flex items-center gap-1 transition-colors"
                  >
                    View Details
      ...
      {/* CTA Section */}
      <section className="bg-[#922B21] text-white py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold mb-6">
            Need Help with Engineering Admissions?
          </h2>
          <p className="text-xl mb-8 text-gray-200 max-w-2xl mx-auto">
            Get expert guidance from our counselors to choose the right engineering college and exam preparation strategy.
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            <button onClick={openModal} className="bg-white text-[#922B21] hover:bg-gray-100 font-bold px-8 py-4 rounded-lg transition-colors flex items-center gap-2">
              <Phone size={20} />
              Talk to Counselor
            </button>
            <button className="border-2 border-white hover:bg-white hover:text-[#922B21] font-bold px-8 py-4 rounded-lg transition-colors">
              Download Free Guide
            </button>
          </div>
        </div>
